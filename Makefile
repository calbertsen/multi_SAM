...
clean: clean_testmore_stockassessment
	...
	@echo "\033[0;32mCleaning autogenerated files\033[0;0m"
	@rm -f multiStockassessment/src/A_*
	@rm -f multiStockassessment/src/M_*
	@rm -f multiStockassessment/src/SAM.h
	@rm -f multiStockassessment/src/MSAM.h
	@echo "\033[0;32mCleaning compiled code\033[0;0m"
	@rm -f multiStockassessment/src/*.o
